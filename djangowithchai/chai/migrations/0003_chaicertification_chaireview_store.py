    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chai', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='certification', to='chai.chaivarity')),
            ],
        ),
        migrations.CreateModel(
            name='ChaiReview',
            fields=[
                ...
                ('review_added', models.DateTimeField(default=django.utils.timezone.now)),
